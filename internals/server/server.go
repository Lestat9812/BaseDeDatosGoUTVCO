...
import (
	"AlmacenGo/internals/core/middlewares"
	"AlmacenGo/internals/core/ports"
...
type Server struct {
	entradaHandler         ports.IEntradaHandler
	municipioHandler       ports.IMunicipioHandler
	localidadHandler       ports.ILocalidadHandler
	regionHandler          ports.IRegionHandler
	inmuebleHandler        ports.IInmuebleHandler
	programaHandler        ports.IProgramaHandler
	salidaHandler          ports.ISalidaHandler
	categoriaHandler       ports.ICategoriaHandler
	productoHandler        ports.IProductoHandler
	presentacionHandler    ports.IPresentacionHandler
	entradaProductoHandler ports.IEntradaProductoHandler
	inventarioHandler      ports.IInventarioHandler
	salidaProductoHandler  ports.ISalidaProductoHandler
	encargadoHandler       ports.IEncargadoHandler
	personaHandler         ports.IPersonaHandler
	usuarioHandler         ports.IUsuarioHandler
	externos               ports.IExternoHandler
}

func NewServer(eHandler ports.IEntradaHandler, mHandler ports.IMunicipioHandler, lHandler ports.ILocalidadHandler, rHandler ports.IRegionHandler,
